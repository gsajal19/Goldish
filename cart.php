  ...
  <head>
    ...
    <script type="text/javascript" id="wc-cart-js-extra">
      ...
      var wc_cart_params = {
        ajax_url: "\/goldish\/demo\/wp-admin\/admin-ajax.php",
        wc_ajax_url: "\/goldish\/demo\/?wc-ajax=%%endpoint%%",
        update_shipping_method_nonce: "541e37d722",
        apply_coupon_nonce: "d34973a80a",
        remove_coupon_nonce: "a3ed70ebaf",
      };
      /* ]]> */
    </script>
    <script
  ...
  >
    <div class="l-wrap">
      ...
      <div class="l-inner">
        ...
        <div
          class="c-post__container l-section l-section--container l-section--bottom-margin l-section--no-sidebar c-post__container--cart"
        >
            ...
            <div class="woocommerce">
              <div class="c-cart-empty">
                <div class="c-cart-empty__image-wrap">
                  <!-- <i
                    class="ip-cart-empty c-cart-empty__icon c-cart-empty__icon--failed"
                  ></i> -->
                  <i class="fa fa-cart-plus c-cart-empty__icon c-cart-empty__icon--failed" aria-hidden="true"></i>

                </div>
                <h2 class="c-cart-empty__header">
    ...
    />
      ...
      <script type="text/javascript" id="wp-api-fetch-js-after">
        ...
        wp.apiFetch.nonceMiddleware =
          wp.apiFetch.createNonceMiddleware("2e626bcfcd");
      ...
      <script type="text/javascript" id="woobt-frontend-js-extra">
        ...
        var woobt_vars = {
          ...
          alert_selection:
            "Please select a purchasable variation for [name] before adding this product to the cart.",
        };
        /* ]]> */
      </script>
      <script
